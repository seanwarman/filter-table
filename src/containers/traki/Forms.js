...
export default class Forms extends Component {
    ...
    loadAnalytics() {
        ...
        return API.get('biggly', `/traki/key/${this.props.user.apiKey}/forms/${localStorage.traki_website_key}/start/${this.state.drStart}/end/${this.state.drEnd}`);

    }

    loadPage = async () => {

        // this.props.changeHeader("Traki Forms");
        this.props.changeHeader('sound','Traki',[{name: 'Traki Forms', url: '/traki/forms'}]);
