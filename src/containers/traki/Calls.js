...
export default class Calls extends Component {
    ...
    loadAnalytics() {
        ...
        return API.get('biggly', `/traki/key/${this.props.user.apiKey}/calls/${localStorage.traki_website_key}/start/${this.state.drStart}/end/${this.state.drEnd}`);

    }

    loadPage = async () => {

        // this.props.changeHeader("Traki Calls");
        this.props.changeHeader('sound','Traki',[{name: 'Traki Calls', url: '/traki/calls'}]);
