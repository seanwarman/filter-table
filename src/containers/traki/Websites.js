...
export default class Websites extends Component {
    ...
    createNotify(notifyObject) {
      ...
      return this.props.api.createPublic({
        ...
        // return API.post("biggly", `/notify/key/${this.props.user.apiKey}/emails`, {
        //     body: notifyObject
        // });
    }
    ...
    async componentDidMount() {
        ...
        try {
            ...
            this.props.changeHeader('sound','Traki',[{name: 'Websites', url: '/traki/websites'}]);
    ...
    websites() {
        ...
        return API.get("biggly", `/traki/key/${this.props.user.apiKey}/websites`);
    }
    ...
    render() {
        ...
        const columns = [{
            ...
            ...this.getColumnSearchProps('ws_name'),
        }, {
            title: 'URL',
            dataIndex: 'ws_url',
            key: 'ws_url',
        ...
        function viewWebsite(record) {
            ...
            localStorage.traki_website_key = record.ws_key;
            localStorage.traki_website_name = record.ws_name;

            that.props.history.push(`/traki/analytics/`);
        }
                ...
                <Row gutter={16}>
                    <Col xs={24}>
                        <Card bordered={false} style={{'width': '100%'}}>
                            ...
                            <Row>
                                <Col span={24}>
                                    <Table size="small"  onChange={onChange} onRow={(record, rowIndex) => { return { onClick: (event) => { viewWebsite(record); } }}}  rowClassName={'bms_clickable'} rowKey="ws_Key" dataSource={this.state.websites} columns={columns}>
                                    </Table>
                                </Col>
                            </Row>
                        </Card>
